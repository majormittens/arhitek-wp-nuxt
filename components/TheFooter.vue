...
<div class="bg-white pt-4 sm:pt-10 lg:pt-12">
    ...
    <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
            <div class="col-span-full lg:col-span-6">
                ...
                <div class="lg:-mt-2 mb-4">
                    <nuxt-link to="/" class="inline-flex items-center text-black-800 text-xl md:text-2xl font-bold gap-2" aria-label="logo">
                        Inspirescu Studio
                    </nuxt-link>
                </div>
                <!-- logo - end -->

                <p class="text-gray-500 sm:pr-8 mb-6">Copyright © 2021 Inspirescu Studio - Toate drepturile rezervate, conform Legii nr. 18/1996 privind drepturile de autor.</p>

                <!-- social - start -->
                <div class="flex gap-4">
                    <a href="https://instagram.com/inspirescu_studio?igshid=YmMyMTA2M2Y=" target="_blank" class="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100">
        ...
        <div class="text-gray-400 text-sm text-center border-t py-8">© 2021 - Present Inspirescu Studio. All rights reserved.</div>
    </footer>
</div>
</template>
