...
<header class="grid auto-rows-auto sm:flex justify-start items-center border-b py-4 md:py-8 mb-8 md:mb-12 xl:mb-16">
    ...
    <div class="flex flex-col">
        <div class="px-4 md:px-8">
            <div class="p-1 flex flex-col md:flex-row items-center">
                ...
                <p class="text-gray-700 ml-1 text-lg"> | office@inspirescu.com | 0799264222</p>
            </div>
        </div>
        <!-- nav - start -->
    ...
    <!-- buttons - start -->
    <button type="button" class="absolute right-0 mr-2 max-w-32 inline-flex items-center lg:hidden bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-indigo-300 text-gray-500 active:text-gray-700 text-base md:text-base font-semibold rounded-lg gap-2 px-2.5 py-2">
