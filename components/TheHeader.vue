...
<header class="grid auto-rows-auto sm:flex justify-start items-center border-b py-4 md:py-8 mb-8 md:mb-12 xl:mb-16">
    ...
    <!-- buttons - start -->
    <button type="button" class="absolute right-0 mr-2 max-w-32 inline-flex items-center lg:hidden bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-indigo-300 text-gray-500 active:text-gray-700 text-sm md:text-base font-semibold rounded-lg gap-2 px-2.5 py-2">
